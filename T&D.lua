...
OthersTab:CreateButton({
   ...
   Callback = function()
       ...
       songIdInput.Size = UDim2.new(0, 200, 0, 50)
       songIdInput.Position = UDim2.new(0.5, -100, 0.2, 0)
       songIdInput.PlaceholderText = "Enter Song ID"
       songIdInput.TextColor3 = Color3.fromRGB(255, 255, 255)
       songIdInput.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
       songIdInput.Parent = frame
       ...
       stopButton.Position = UDim2.new(0.5, 0, 0.6, 0)
...
OthersTab:CreateButton({
   ...
   Callback = function()
       ...
       Rayfield:Notify({Title = "Loaded", Content = "Hexagon Client Started", Duration = 2})
   end,
})
...
OthersTab:CreateButton({
   ...
   Callback = function()
       ...
       Rayfield:Notify({Title = "Loaded", Content = "Quick Chat Started", Duration = 2})
   end,
})
...
OthersTab:CreateButton({
   ...
   Callback = function()
       ...
       Rayfield:Notify({Title = "Loaded", Content = "Hack Lord Started", Duration = 2})
   end,
})
...
OthersTab:CreateButton({
   ...
   Callback = function()
       ...
       Rayfield:Notify({Title = "Loaded", Content = "Time Travel Started", Duration = 2})
   end,
})
