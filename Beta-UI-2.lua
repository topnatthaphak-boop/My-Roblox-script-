-- [[ T&D Phoenix A: Final Edition (UIGradient Enhanced) ]]
local PhoenixLib = {}
...
function PhoenixLib:CreateWindow(name)
    ...
    -- [[ ระบบ UI Gradient แบบใหม่ที่เหนือกว่าเดิม ]]
    ...
    -- ตั้งค่าสีรุ้งมาตรฐาน (คุณสามารถเปลี่ยนสีใน ColorSequence นี้ได้)
    ...
    -- โค้ดควบคุมการวิ่งของสีที่คุณต้องการ
    local speed = 2 
    local rotSpeed = 90 
    ...
    RunService.RenderStepped:Connect(function(dt)
        ...
        -- ทำให้สีหมุน (Rotation)
        Gradient.Rotation = Gradient.Rotation + (dt * rotSpeed)
    end)
    -- [[ จบระบบ UI Gradient ]]
...
-- [ ส่วนที่เหลือของสคริปต์ยังคงเดิม ]
